    ...
    for player in players:
        ...
        for name in names:
            ...
            responseMatchesPlayer = site.cargo_client.query(
                    ...
                    where = "SP.Link='" + name['AllName'] + "' AND (SP.OverviewPage='Volcano League/2022 Season/Closing Playoffs')",
...
def queryPlayersDataTableForAllTournaments():
    ...
    response = site.cargo_client.query(
        ...
        fields = "P.OverviewPage, P.ID, P.Name, P.Country, P.Age, P.Role, P.Team",
        # Todos los equipos.
        where = '(P.Team="Descuydado Esports" OR P.Team="Skull Cracker" OR P.Team="Pirate Dream" OR P.Team="AceS GaminG" OR P.Team="Geekside Esports" OR P.Team="Waia Snikt" OR P.Team="Aguilas Doradas" OR P.Team="God\'s Plan") AND ' +
                "(P.Role='Top' OR P.Role='Jungle' OR P.Role ='Mid' OR P.Role='Bot' OR P.Role='Support')",
        order_by= "P.ID ASC"
    )
